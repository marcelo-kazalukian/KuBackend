 ...
 * Copiado de core/libs/auth2/auth2.php
 */
...
abstract class MyAuth {
    ...
    /**
     * Encripta un string según el algoritmo seleccionado
     *     
     * @param $password
     * @return $password encriptado
     */
    public static function encriptar($password, $algoritmo = PASSWORD_DEFAULT) {

        return password_hash($password, $algoritmo);
    }

    /**
     * Verifica si el pass enviado corresponde al hash.
     *     
     * @param $password
     * @return $password encriptado
     */
    public static function verificar_pass($password, $hash) {
